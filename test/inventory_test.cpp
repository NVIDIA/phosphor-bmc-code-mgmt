...
/* verifies that inventory manager starts up, adds a version object and
   populates the basic fields in the object as well as all 4 expected
   associations are generated (active, activation, functional, and updateable)
 */
TEST(InventoryTest, InventoryManager)
{
    ...
    EXPECT_CALL(sdbus_mock,
                sd_bus_emit_properties_changed_strv(
                    IsNull(), StartsWith("/xyz/openbmc_project/software/"),
