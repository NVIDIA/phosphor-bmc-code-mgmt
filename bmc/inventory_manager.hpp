    ...
    ManufacturerInherit
{
  public:
     ...
     */
    InventoryManager(sdbusplus::bus_t& bus) :
     ...
     * recreation upon reboot and clears the autogenerated host-interface
     * mac address (host side) in u-boot bootargs. */
    void reset() override
    {
     ...
     * recreation upon reboot, clears logs and diagnostic data and clears
     * the autogenerated host-interface mac address (host side) in
     * u-boot bootargs. */
